 ...
 * Compact custom UI for the HolafResolutionPresetV2 node.
 *
...
const NODE_TYPE = "HolafResolutionPresetV2";
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            if (missing) {
                console.warn(`[Holaf.ResolutionPresetV2] Widget '${missing}' introuvable — UI custom désactivée.`);
                return;
            }
